...
ws_dash['B2'] = 'Projekt-Dashboard'
ws_dash['B2'].font = Font(size=22, bold=True, color='203764')

# -- Table 1: Status (Fixed Range Problem: Use Countifs on entire column F) --
row = 5
...
# -- Table 2: Team Workload (Columns Lead=H(8), Co=I(9)) --
row_wl = 5
col_wl = 5
